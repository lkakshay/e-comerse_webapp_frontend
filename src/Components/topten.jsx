...
export const Topten=()=>{
    return(
        ...
        <Box sx={{ py:'40px',px:'3%',backgroundColor:"#ebf0f0"}}>
                      
      <Grid container  sx={{backgroundColor:"#ffffff",p:'2%'}}>
        {Array.from(Array(10)).map((_, index) => (
          <Grid  item xs={6} sm={4} md={3} lg={12/5} key={index} sx={{display:"flex",justifyContent:'center'}} >

            <Card sx={{ width:'100%' ,m:'3%' ,boxShadow: "rgba(0, 0, 0, 0.1) 0px 0px 5px 0px, rgba(0, 0, 0, 0.1) 0px 0px 1px 0px",borderRadius:"0px"}}>
